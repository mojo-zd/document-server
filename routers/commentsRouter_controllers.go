...
func init() {
	...
	beego.GlobalControllerRouter["github.com/document-server/controllers:TempFile"] = append(beego.GlobalControllerRouter["github.com/document-server/controllers:TempFile"],
		beego.ControllerComments{
			Method:           "UploadFile",
			Router:           `/file/upload`,
			AllowHTTPMethods: []string{"post"},
